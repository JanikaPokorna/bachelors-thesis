...
function[] = run_analysis_CG_orthodir_comparison(runName, A, b, x0, maxiter, tol, spanA, kerA)
    arguments 
        runName
        A
        b
...
for i = 1:size(b,2)
    ...
    h(i) = semilogy(1:maxiter, Error_matrices{i}(1:maxiter), '-', ...
        'Color', colors{i}, 'LineWidth', 3);
    
    % _2 version curves (dashed)
    h_2(i) = semilogy(1:maxiter, Error_matrices_2{i}(1:maxiter), '--', ...
